...
const toastVariants = cva(
  // Swipe direction is "up" (see ToastProvider in toaster.tsx) to match toasts
  // rendering at the top of the screen on mobile -- swiping a toast off the
  // top of the screen is the natural dismiss gesture there. translate-y (not
