      ...
      <TooltipProvider delayDuration={300}>
        <Tooltip>
          <TooltipTrigger asChild>
            <button 
              onClick={onLike}
              className={`flex items-center space-x-1 ${isLiked ? 'text-primary' : 'text-gray-500'} ${isOwner ? 'cursor-not-allowed' : 'cursor-pointer'}`}
          ...
          <TooltipContent className="bg-black/75 text-white border-none text-xs p-2">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button 
                ...
                className={`py-1.5 px-3 rounded-full text-xs font-medium flex items-center cursor-pointer ${
                  showInterest 
