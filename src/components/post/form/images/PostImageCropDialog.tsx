...
/**
 * Preview-frame picker for newly uploaded post images (runs AFTER
 * PostImageTrimDialog's optional rotate/trim step, Trello C4). The image
 * itself is never altered or re-encoded here — this only records which
 * square region (as fractions of the image) should be used to frame the
 * feed/card thumbnail. The full (possibly already rotated/trimmed) image
 * is always what gets uploaded and shown when a viewer opens it.
 */
