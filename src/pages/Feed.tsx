...
export default function Feed() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Sticky logo header */}
      <header className="sticky top-0 z-40 w-full flex justify-center pt-2 pb-2 px-2 bg-background/90 backdrop-blur supports-[backdrop-filter]:bg-background/75 border-b border-border/40">
        <img
